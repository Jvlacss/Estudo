...
--
-- Table structure for table `aperfeiçoamento`
--

DROP TABLE IF EXISTS `aperfeiçoamento`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `aperfeiçoamento`
--

/*!40000 ALTER TABLE `aperfeiçoamento` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `aperfeiçoamento` ENABLE KEYS */;
...
--
-- Table structure for table `posgrad`
--

DROP TABLE IF EXISTS `posgrad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `posgrad`
--

/*!40000 ALTER TABLE `posgrad` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `posgrad` ENABLE KEYS */;
...
-- Dump completed on 2025-05-15 21:30:25
